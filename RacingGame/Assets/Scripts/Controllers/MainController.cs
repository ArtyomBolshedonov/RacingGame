...
namespace RacingGame
{
    internal sealed class MainController : BaseController
    {
        ...
        public MainController(Transform placeForUi, ProfilePlayer profilePlayer, IAdsShower adsShower, IAnalyticTools analyticTools)
        {
